...
<head>
    ...
    <link rel="stylesheet" href="/app/Views/Css/admin/AdminCustomer.css" />
...
<body>
    <header data-spy="affix">
        <img src="/Images_Web/Logo/Logo_Admin.svg" class="logo"0>
        <div class="icon2">
    ...
    <div class="thanhtimkiem">
        <input  type="text" id="mySearch" onkeyup="myFunction()" placeholder="Khách hàng" title="Type in a category" />
